...
export default function HomeUser() {
  ...
  return (
    <Layout>
      <h1 className="font-semibold text-3xl md:text-4xl mb-5 text-center">Explore & Learn</h1>
      <h2 className="text-lg md:text-xl text-gray-700 text-center mb-8">Latest news on courses</h2>
      <hr />
      ...
      <div className="mt-5 flex flex-col gap-8 px-4 md:px-0">
        {isLoading ? (
          ...
          <p className="text-center text-red-500">Error loading courses, please try again.</p>
        ) : (
      ...
      <div className="mt-16 text-center px-4 md:px-0">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-20 justify-center">
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-gray-700 text-sm md:text-base">Live class</p>
          </div>
          <div className="flex flex-col items-center">
            <Award width={40} height={40} className="text-red-600" />
            <p className="mt-2 text-gray-700 text-sm md:text-base">Digital Certificates</p>
          </div>
          <div className="flex flex-col items-center">
            <MapPin width={40} height={40} className="text-red-600" />
            <p className="mt-2 text-gray-700 text-sm md:text-base">Locations</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-20 text-center px-4 md:px-0">
        ...
        <h2 className="text-2xl font-semibold mt-4">Our Company</h2>
